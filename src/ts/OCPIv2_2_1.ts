...
export class OCPIV2_2_1 {
    ...
    public RenderEndpoints(endpoints:  Array<IOCPIv2_2_1.IEndpoint>,
    ...
    private async GetCDRs(CDRsURL: string)
    {
        ...
        this.common.OCPISearch<IOCPIv2_2_1.ICDRMetadata,
                               IOCPIv2_2_1.ICDR>(
    ...
    private async GetLocations(LocationsURL: string)
    {
        ...
        this.common.OCPISearch<IOCPIv2_2_1.ILocationMetadata,
                               IOCPIv2_2_1.ILocation>(
    ...
    private async GetSessions(SessionsURL: string)
    {
        ...
        this.common.OCPISearch<IOCPIv2_2_1.ISessionMetadata,
                               IOCPIv2_2_1.ISession>(
    ...
    private async GetTariffs(TariffsURL: string)
    {
        ...
        this.common.OCPISearch<IOCPIv2_2_1.ITariffMetadata,
                               IOCPIv2_2_1.ITariff>(
    ...
    private async GetTokens(TokensURL: string)
    {
        ...
        this.common.OCPISearch<IOCPIv2_2_1.ITokenMetadata,
                               IOCPIv2_2_1.IToken>(
